    ...
    <div className="relative max-w-[520px] rounded-card border border-line bg-paper p-[clamp(22px,2.4vw,34px)] shadow-[0_1px_2px_rgba(11,21,51,.04),0_30px_60px_-34px_rgba(11,21,51,.4)]">
      ...
      <div className="flex min-h-[3.4em] items-center gap-[clamp(16px,2vw,24px)]" style={fade}>
        ...
        <div>
          ...
          <p className="font-mono text-[0.74rem] leading-[1.5] tracking-[0.02em] text-sage">
            {slide.capSub}
          </p>
        </div>
      </div>
      ...
      {/* divider */}
      <div className="my-[1.1rem] mt-[1.5rem] flex items-center gap-[0.8em] font-mono text-[0.72rem] uppercase tracking-[0.08em] text-sage">
        {slide.divider}
      ...
      <div className="mb-[0.85rem] flex items-center gap-[0.85em]">
        ...
        <div>
          ...
          <span className="block font-mono text-[0.72rem] tracking-[0.02em] text-sage">
      ...
      <div className="mt-[1.4rem] flex items-center gap-[1.3rem] border-t border-line-soft pt-[1.2rem] text-[0.84rem] text-ink-soft">
        ...
        <span className="ml-auto flex gap-[0.4em]" aria-hidden>
          {SLIDES.map((_, i) => (
            <span
              key={i}
              className={`h-[6px] rounded-full transition-all ${i === idx ? "w-[18px] rounded-[3px] bg-honey" : "w-[6px] bg-line"
                }`}
            />
          ))}
        </span>
