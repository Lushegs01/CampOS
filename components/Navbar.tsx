      ...
      <div className="mx-auto flex h-[74px] max-w-wrap items-center justify-between px-[clamp(20px,5vw,56px)]">
        ...
        <ul className="hidden items-center gap-8 md:flex">
          <li>
            <Link
              href="#modules"
              className="relative text-[0.95rem] font-medium text-ink-soft transition-colors hover:text-ink after:absolute after:-bottom-[5px] after:left-0 after:h-[1.5px] after:w-0 after:bg-honey after:transition-all hover:after:w-full"
            >
              Modules
            </Link>
          </li>
