...
interface UniversityNode {
  ...
  name: string;
  location: string;
  x: number; // coordinate out of 1024
  y: number; // coordinate out of 1024
  students: string;
      ...
      <div className="mx-auto max-w-wrap px-[clamp(20px,5vw,56px)] relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-[clamp(24px,3vw,48px)] items-center">
          ...
          <div className="lg:col-span-6 flex justify-center items-center">
            <div className="relative w-full max-w-[380px] aspect-[1/1] bg-white/[0.01] border border-white/[0.04] rounded-3xl p-6 backdrop-blur-sm overflow-hidden group shadow-2xl">
